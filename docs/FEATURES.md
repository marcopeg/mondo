...
- **Paste images into properties** – Paste images from clipboard (e.g., screenshots) directly into any property field. The image is automatically saved as a file and linked in the frontmatter (`src/events/inject-property-paste.ts`).
